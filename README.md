...
Stop! This is an untested, initial commit.  It probably doesn't work. Once I test all of this, I'll update this documentation.

An [ESP-01](https://academy.cba.mit.edu/classes/networking_communications/ESP8266/esp01.pdf) adapter board for [WowWee Labs'](https://github.com/WowWeeLabs/) [MiP](https://wowwee.com/mip) robot.  Similar to the [MiP ProMini Pack](https://github.com/adamgreen/MiP_ProMini-Pack), this board adapts the ESP-01 to MiP.  Either install the ESP-01 to a pin header or solder it directly to the board and you'll be programming MiP to connect to the Internet in no time.
...
## OSH Park renderings
<img src="https://github.com/Tiogaplanet/MiP_D1-mini-Pack/raw/v3/images/top.png" alt="The top of the MiP ESP-01 pack" width="300">

<img src="https://github.com/Tiogaplanet/MiP_D1-mini-Pack/raw/v3/images/bottom.png" alt="The bottom of the MiP ESP-01 pack" width="300">
